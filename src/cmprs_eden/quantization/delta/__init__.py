...
from cmprs_eden.quantization.cluster_distribution import normal_cluster_dist as norm_c
from cmprs_eden.quantization.entropy_delta import ENTROPY_DELTAS_FILE, ENTROPY_DELTA_CENTROIDS_FILE, ENTROPY_DELTA_EPS_FILE
from cmprs_eden.quantization.quantizer import Quantizer
