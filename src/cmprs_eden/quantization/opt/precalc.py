...
from cmprs_eden.quantization.opt import OPT_CENTROIDS_FILE, OPT_EPS_FILE
from cmprs_eden.quantization.opt.lloyd_max_1d_symmetric import LloydMax1DSymmetric
